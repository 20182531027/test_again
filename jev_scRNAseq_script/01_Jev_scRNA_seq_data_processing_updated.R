...
pv <- VlnPlot(scRNA.T,features = c("Ly6c2",
                                   "Cx3cr1",
                                   "Snap25",
                                   "Nkg7","Cd3e",
                                   "Plp1",
                                   ...
                                   "Vtn",
                                   "Tubb2b","Nnat",
                                   "Hbb-bt"), stack = TRUE, sort = FALSE,flip = TRUE)+ theme(legend.position = "none",plot.title = element_text(size = 20, hjust = 0.5))+ggtitle("cell marker")
ggsave("Fig.1f_celltypes_stacked_violin_plot.pdf",pv,width = 10,height = 7,dpi=300)
